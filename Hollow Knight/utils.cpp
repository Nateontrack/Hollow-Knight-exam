...
std::string utils::GetAttributeValue(const std::string& attribute, const std::string& srcString)
{
...
void utils::DeleteAttribute(const std::string& attribute, std::string& srcString)
{
	const std::string startSequence{ "<" + attribute + ">" };
	const std::string endSequence{ "</" + attribute + ">" };
